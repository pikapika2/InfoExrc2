...
public class Tutorial extends JPanel implements ActionListener{
	...
	public void paintComponent(Graphics g){
        ...
        if(paused){
        	...
        	g.drawString("???????????????????", B_WIDTH/2 - 20, B_HEIGHT/2);
        	Myfont.setGraphicFontSize(g, 10);
        	g.drawString("P??????????????????????????????????????????????????", B_WIDTH/2 - 60, B_HEIGHT/2 + 20);
        }
        if (tuto) {
        	if(tuto_mv){
            	g.setColor(new Color(0,0,0,150));
            	...
            	Myfont.setGraphicFont(g);
            	g.setColor(Color.white);
            	g.drawString("~?????????????????????????~", B_WIDTH/2 - 35, B_HEIGHT/2);
            	Myfont.setGraphicFontSize(g, 10);
            	g.drawString("?????????????????(????,????,????,????)??????????????????????????????", B_WIDTH/2 - 85, B_HEIGHT/2 + 20);
            	g.drawString("T???????????????????????????????????????????????", B_WIDTH/2 - 60, B_HEIGHT/2 + 40);
            }
            if(tuto_st){
            	g.setColor(new Color(0,0,0,150));
            	g.fillRect(0, 0, 500, 500);
            	...
            	Myfont.setGraphicFont(g);
            	g.setColor(Color.white);
            	g.drawString("~??????????????????????????????~", B_WIDTH/2 - 45, B_HEIGHT/2);
            	Myfont.setGraphicFontSize(g, 10);
            	g.drawString("????????????????????????????????????????????????????????????????????????????????????????????????", B_WIDTH/2 - 135, B_HEIGHT/2 + 20);
            	g.drawString("T??????????????????????????????????????????", B_WIDTH/2 - 70, B_HEIGHT/2 + 40);
            }
            if(tuto_dm){
            	g.setColor(new Color(0,0,0,150));
            	g.fillRect(0, 0, 500, 500);
            	...
            	Myfont.setGraphicFont(g);
            	g.setColor(Color.white);
            	g.drawString("~?????????????????????????????????????~", B_WIDTH/2 - 50, B_HEIGHT/2-10);
            	Myfont.setGraphicFontSize(g, 10);
            	g.drawString("????????????????????????????????????????????????????????????0???????????????????????????????????????????????????", B_WIDTH/2 - 155, B_HEIGHT/2 + 10);
            	g.drawString("?????????????????????=???????????????????????????????????????????????????????????????????????", B_WIDTH/2 - 135, B_HEIGHT/2 + 30);
            	g.drawString("T??????????????????????????????????????????", B_WIDTH/2 - 55, B_HEIGHT/2 + 50);
            }
            if(tuto_it){                            //after
            	g.setColor(new Color(0,0,0,150));
            	g.fillRect(0, 0, 500, 500);
            	...
            	Myfont.setGraphicFont(g);
            	g.setColor(Color.white);
            	g.drawString("~??????????????????????????????????????~", B_WIDTH/2 - 55, B_HEIGHT/2);
            	Myfont.setGraphicFontSize(g, 10);
            	g.drawString("????????????????????????????????????????????????????????????", B_WIDTH/2 - 65, B_HEIGHT/2 + 20);
            	g.drawString("T??????????????????????????????????????????????????????????????????T????????????????????????????????????????????????????", B_WIDTH/2 - 200, B_HEIGHT/2 + 40);
            }
